...
p=plot(both,x=:difference,y=:edges,color=:color,Geom.bar,Coord.Cartesian(xmin=-0.5,xmax=25.5,ymin=0.0,ymax=0.2),Guide.xticks(ticks=[5*n for n in 0:5]),Guide.manual_color_key("",["ordinary", "preference"], [palette[1], palette[8]],pos=[0.55w,-0.28h]),Theme(bar_spacing=0.01inch,minor_label_font_size=10pt,key_label_font_size=10pt,background_color="white"))
draw(PNG("l25.png",3.5inch, 2.5inch), p)
